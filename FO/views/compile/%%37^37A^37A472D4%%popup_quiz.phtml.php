<?php /* Smarty version 2.6.19, created on 2015-12-16 08:26:46
         compiled from Contrib/popup_quiz.phtml */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'Contrib/popup_quiz.phtml', 138, false),)), $this); ?>
<?php echo '
...
">-->
				...
				<div class="pull-right">
					...
					<?php if ($this->_tpl_vars['next_id']): ?>
						<a class="btn btn-primary" id="loadQuestion" href="/quiz/participate-quiz?article_id=<?php echo $this->_tpl_vars['question']['article_id']; ?>
&quiz_identifier=<?php echo $this->_tpl_vars['question']['quizz_id']; ?>
&question_id=<?php echo $this->_tpl_vars['next_id']; ?>
" id="btnPlayQuizz">Confirm my answer</a>
					<?php else: ?>
...
">
				<input type="hidden" name="article_id" value="<?php echo $this->_tpl_vars['question']['article_id']; ?>
">
