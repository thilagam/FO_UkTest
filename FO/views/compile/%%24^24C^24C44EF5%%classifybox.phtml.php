<?php /* Smarty version 2.6.19, created on 2016-03-21 12:08:10
         compiled from Contrib/classifybox.phtml */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'Contrib/classifybox.phtml', 28, false),array('modifier', 'truncate', 'Contrib/classifybox.phtml', 36, false),array('modifier', 'stripslashes', 'Contrib/classifybox.phtml', 36, false),array('modifier', 'date_format', 'Contrib/classifybox.phtml', 40, false),)), $this); ?>
<?php echo '
...
?>
								...
								<div class="clearfix read">
									<a href="/contrib/classify-messages?page=<?php echo $_REQUEST['page']; ?>
										...
										<ul class="unstyled">
											...
											<li class="d">
												<?php if (((is_array($_tmp=time())) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d/%m/%Y") : smarty_modifier_date_format($_tmp, "%d/%m/%Y")) == ((is_array($_tmp=$this->_tpl_vars['message']['updated_at'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d/%m/%Y") : smarty_modifier_date_format($_tmp, "%d/%m/%Y"))): ?>
													<?php echo ((is_array($_tmp=$this->_tpl_vars['message']['updated_at'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%I.%M %p") : smarty_modifier_date_format($_tmp, "%I.%M %p")); ?>
