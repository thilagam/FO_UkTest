<?php /* Smarty version 2.6.19, created on 2015-01-30 12:19:31
         compiled from Contrib/pattern/footer2.phtml */ ?>
 <section id="stats">
	 <div class="container">
		 <header>
...
<footer class="footer">
     <div class="container">
        <p class="pull-right"><a href="#brand" class="pull-right btn btn-small disabled anchor-top scroll"><i class="icon-arrow-up"></i></a></p>
		...
		<div>
			<a href="http://www.edit-place.com" rel="tooltip" data-original-title="France"><img class="flag flag-fr" src="/FO/images/shim.gif"></a>
