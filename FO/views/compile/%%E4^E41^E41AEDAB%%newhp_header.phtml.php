<?php /* Smarty version 2.6.19, created on 2015-02-04 07:38:22
...
<div id="switch-country" class="animated fadeInDown">
	<div class="container">
		<div class="alert fade in">
			<button aria-hidden="true" data-dismiss="alert" class="close" type="button" onClick="switchalert('en');">&times;</button>
			<h4>We've detected you are coming from a location in France.<br>  
			Nous avons détecté que vous vous connectez depuis un lieu situé en France
			</h4>
			...
			<a class="btn btn-default" onClick="switchalert('fr');" href="javascript:void(0);" ><span class="flag flag-fr"></span> Français</a>
		</div>
	</div>
</div>  
<?php endif; ?>
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					...
					<ul class="nav navbar-nav navbar-right">
						...
						<?php if ($this->_tpl_vars['usertype'] != 'contributor'): ?><li><a class="navbar-btn btn btn-primary btn-sm" href="/client/quotes-1">Our prices</a></li><?php endif; ?>
	...
	<div id="playground">
		...
		<div class="container">
			...
			<div class="center-block">
				...
				<h1>Writing and translation of exclusive online content<small>Available in more than 30 languages</small></h1>
				<!--<h1>Rédaction et traduction sur mesure <small>Disponibles dans plus de 30 langues</small></h1>-->

				<div class="cta-collections">

					<a href="/client/quotes-1" class="btn btn-primary btn-lg" role="button">Our prices</a>

					<a href="https://www.youtube.com/watch?v=A9P5dT1Rp9Y" data-toggle="lightbox" data-type="youtube" data-width="940" class="btn btn-info btn-lg" role="button"><span class="glyphicon glyphicon-play"></span> Our video</a>
