...
class paypal_class {
   ...
   function submit_paypal_post() {
      ...
      echo '<center><div class="title2">
									Merci de patienter pendant que nous vous<br>
									redirigeons vers le serveur s&eacute;curis&eacute; de<br>
									notre prestataire de paiement
								</div>
								<br>
								<img src="https://mmm-en.edit-place.com/FO/images/load.gif">';
      echo "</center>\n";
