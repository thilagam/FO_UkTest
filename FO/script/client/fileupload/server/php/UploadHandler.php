...
class UploadHandler 
{
    ...
    function __construct($options = null, $initialize = true) {
		...
		$this->options = array(
           ...
           //'upload_dir' => dirname($_SERVER['SCRIPT_FILENAME']).'/files/',
            'upload_dir' => '/home/sites/site13/web/FO/spec_temp/'.$today.'/',
           // 'upload_url' => $this->get_full_url().'/files/',
            'upload_url' => 'http://ep-test.edit-place.co.uk/FO/spec_temp/'.$today.'/',
            'user_dirs' => false,
            'mkdir_mode' => 0777,
            'param_name' => 'files',
    ...
    protected function get_upload_path($file_name = null, $version = null) {
        $file_name = $file_name ? utf8_decode($file_name) : '';
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error,
        ...
        if ($this->validate($uploaded_file, $file, $error, $index)) {
            ...
            if ($file_size === $file->size) {
                ...
                /**Author:Thilagam**/
                /**Date:27/5/2016**/
                /**Reason:Throws an error when the client try to upload the file**/
