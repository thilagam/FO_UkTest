<?php /* Smarty version 2.6.19, created on 2015-06-17 12:31:44
         compiled from Contrib/contract.phtml */ ?>
<div class="container">
	...
	<div class="row-fluid">
		...
		<div class="span12" id="state2">
			<ul class="unstyled">
				<li data-original-title="Je propose un devis pour chaque annonce s&eacute;lectionn&eacute;e" rel="tooltip" class="span4"><span class="bid-selection">My selected offers</span></li>
				<li data-original-title="Signature of Edit-place contract" rel="tooltip" class="hightlight span4"><span class="contract">Edit-place contract</span></li>
				<li data-original-title="My quotes can now be seen by Edit-place and its clients" rel="tooltip" class="span4"><span class="participant-ok">Confirmation</span></li>
			</ul>
		</div>
	 </div>
 
	<!-- end, status -->
   <h1>Writer's Agreement<div class="pull-right" id="link-print"><a href="#print-contractForm" class="btn btn-small" ><i class="icon-print"></i> Print the contract</a></div></h1>
 ...
 &pound; (Pounds Sterling)<?php endif; ?></b></span><span> for each item of
		...
		accumulated until the total exceeds £20 (twenty Pounds Sterling), after which time it will 
...
<p>&nbsp;</p>
		...
		<div class="row-fluid">
			...
			<form class="form-horizontal" method="POST" action="/cart/save-participation">
				<div class="control-group">
					<label class="control-label span6 offset1" for="contract">I agree to the terms and conditions of the current contract</label>
				...
				<div class="control-group">
					<label class="control-label span6 offset1" for="contract">I will not start writing/proofreading of the article(s) until Edit-place or the client has confirmed that I have been selected</label>
					<div class="controls span5">
						<label class="radio inline">
							<input type="radio" name="contract1" value="yes">
							Yes
						</label>
						<label class="radio inline">
							<input type="radio" name="contract1" value="no">
							No
						</label>
						<br><br><br><a class="btn" href="/cart/cart-selection">Back</a> <button class="btn btn-primary" id="contract-submit" name="submit">Confirm</button>
					</div>
				</div>
				<textarea name="contract_text" id="contract_text" style="display:none"></textarea>
				<input type="hidden" name="maxpage" value="2"/>				
			</form>
