<?php /* Smarty version 2.6.19, created on 2015-01-07 13:06:20
         compiled from Client/pattern/quotes_footer.phtml */ ?>
<section class="dashit" id="callus">
	...
	<div class="container padding">
		...
		<div class="center-block">
			...
			<h4 style="font-size:20px">Let's talk about your project</h4>

			<h2>020 3302 4494</h2>

			<p>From monday to friday 9 AM - 6 PM</p>

			<a href="/index/contact" class="btn btn-default btn-lg"><span class="glyphicon glyphicon-envelope"></span> Contact us</a>
...
<footer>
	...
	<div class="container">
		...
		<ul class="links">
			<li><a href="/client/quotes-1">Our prices</a></li>
