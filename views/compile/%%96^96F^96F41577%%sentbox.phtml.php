<?php /* Smarty version 2.6.19, created on 2015-06-18 08:44:58
...
"<?php endif; ?>>TO : <?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['message']['sendername'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 20, "...", true) : smarty_modifier_truncate($_tmp, 20, "...", true)))) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : smarty_modifier_stripslashes($_tmp)); ?>
</li>
