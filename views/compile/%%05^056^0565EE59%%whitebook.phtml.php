<?php /* Smarty version 2.6.19, created on 2015-05-05 13:52:01
				...
				//alert(form.serialize());
					$.ajax({
						...
						success: function(result)
						{
							if($.trim(result)=="done")
							{
								$("#whitebookcontent").html(\'<h3>Merci !</h3><p>Nous vous avons envoy&eacute; le lien de t&eacute;l&eacute;chargement sur votre bo&icirc;te email.</p><p>A bient&ocirc;t sur <a href="http://www.edit-place.co.uk">Edit-place.com</a></p>\');
							}
